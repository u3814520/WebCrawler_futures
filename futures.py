...
def crawl(data):
    ...
    print('crawling'+' '+Day)
    r = requests.get('https://www.taifex.com.tw/cht/3/futContractsDate?queryDate={}%2F{}%2F{}'.format(data.year,data.month,data.day))
...
while True:
    ...
    if date < datetime.today() - timedelta(days=1096):
        break
